...
<c:otherwise>
						...
						<c:forEach var="tempCourse" items="${courses}">
								<tr>
									...
									<td><button id="editbutton" type="submit" name="EditButton" value="${tempCourse.id}">Edit</button></td>
									<td><button id="editbutton" type="submit" name="DeleteButton" value="${tempCourse.id}">Delete</button></td>
								</tr>
						</c:forEach>
						</table>
						</c:otherwise>
